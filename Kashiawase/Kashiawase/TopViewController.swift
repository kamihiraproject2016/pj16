...
//    var cards: Array<UIView> = [];
    ...
    let cardImgName: Array<String>! = ["image/Anmitsu.png", "image/Anmitsu.png", "image/Anmitsu.png", "image/Anmitsu.png", "image/Anmitsu.png"];
    ...
    override func viewDidLoad() {
        ...
        //モーダルビュー設定
        modalView = UIView();
        modalView.backgroundColor = UIColor(red: 0.78, green: 0.78, blue: 0.80, alpha: 0.75);
    ...
    func searchBarSearchButtonClicked(searchBar: UISearchBar) {
        ...
        let (results, err) = SD.executeQuery("SELECT * from db_info_cards where name_en = " + searchText!);
        if (err != nil){
            print(err);
            print(results);
